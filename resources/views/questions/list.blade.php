<header class="page__header">
    <h1 class="page__header-title">Все вопросы</h1>
</header>
...
<div class="page__body">
    ...
    <ul class="paginator">
        ...
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=2">2</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=3">3</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=4">4</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=5">5</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=6">6</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=7">7</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=8">8</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=9">9</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=10">10</a>
        </li>
        <li class="paginator__item">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=11">11</a>
        </li>
        <li class="paginator__item next">
            <a class="paginator__item-link"
               href="https://toster.ru/questions/interesting?page=2">Следующие →</a>
        </li>
    </ul>
