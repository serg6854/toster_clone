@if($question->subscribers()->count() >= 1)
        ...
        <ul class="subscribers-list subscribers-list_short">
            @foreach($question->subscribers->take(5) as $subscriber)
                <li class="subscribers-list__item" title="lagudal подписан">
                    <a class="subscribers-list__user-avatar" href="https://toster.ru/user/lagudal">
            ...
            @if($question->subscribers->take(5)->count() < $question->subscribers()->count())
